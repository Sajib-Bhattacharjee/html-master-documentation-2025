<!-- ========================================================= -->
<!-- 📘 HTML5 Complete Tag & Input Reference (2025 Edition)   -->
<!-- ========================================================= -->
  ...
  <ul>
    ...
    <li><a href="#form-tags">Form Tags</a>
      <ul>
        ...
        <li><a href="#tag-fieldset">&lt;fieldset&gt;</a></li>
...
&lt;/head&gt;
    ...
    <ul>
      <li><strong>Best practice:</strong> Always include <code>meta charset</code> and <code>meta viewport</code> for modern web apps.</li>
...
<!-- 🔹 Section: Structural Tags End -->

<!-- 🔹 Section: Text Content Tags Start -->
...
&lt;hr /&gt; &lt;!-- Thematic break --&gt;
  ...
  <section id="tag-strong">
    <h3>&lt;strong&gt; <span role="img" aria-label="highlighter">🖍️</span></h3>
...
<!-- 🔹 Section: Text Content Tags End -->

<!-- 🔹 Section: Media Tags Start -->
...
<!-- 🔹 Section: Media Tags End -->

<!-- 🔹 Section: Links & Navigation Tags Start -->
...
<!-- 🔹 Section: Links & Navigation Tags End -->

<!-- 🔹 Section: List Tags Start -->
...
&lt;/ul&gt;
  ...
  <section id="tag-ol">
    <h3>&lt;ol&gt; <span role="img" aria-label="numbered list">1️⃣</span></h3>
...
<!-- 🔹 Section: List Tags End -->

<!-- 🔹 Section: Table Tags Start -->
...
<!-- 🔹 Section: Table Tags End -->

<!-- 🔹 Section: Form Tags Start -->
...
<!-- 🔹 Section: Form Tags End -->

<!-- 🔹 Section: Input Types Start -->
...
<!-- 🔹 Section: Input Types End -->

<!-- 🔹 Section: Scripting Tags Start -->
...
<!-- 🔹 Section: Scripting Tags End -->

<!-- 🔹 Section: Metadata Tags Start -->
...
<!-- 🔹 Section: Metadata Tags End -->

<!-- 🔹 Section: Interactive Tags Start -->
...
<!-- 🔹 Section: Interactive Tags End -->

<!-- 🔹 Section: Deprecated Tags Start -->
